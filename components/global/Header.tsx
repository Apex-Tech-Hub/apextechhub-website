...
const tabs = [
  ...
  },
  {
    ...
    { name: "Core Team", path: "/teams/core-team" },
    { name: "Certificates", path: "/teams/certificates" },
    ],
  },
   {
    name: "Company",
    path: "",
    children: [{ name: "Certificates", path: "/company/certificates" },
    { name: "Portfolio", path: "/company/portfolio" },
